...
# TESTE 
print(f"\nVida Inicial: {Alastor_G.get_vida()}")
print("--- Alastor tomou uma flechada! (10 de dano) ---")
Alastor_G.receber_dano(10)
print(f"Vida Atual: {Alastor_G.get_vida()}")

print("--- Alastor tomou um meteoro! (999 de dano) ---")
Alastor_G.receber_dano(999)
print(f"Vida Atual: {Alastor_G.get_vida()}")